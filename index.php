    ...
    <main class="bg-scroll bg-no-repeat bg-cover bg-blend-overlay bg-violet-300 bg-center min-h-screen p-4" style="background-image: url('./catatan/background.jpg')">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="shadow-xl rounded-xl py-2">
                ...
                <div>
                    <img class="mx-auto my-2" src="/catatan/soal.PNG">
                </div>
            ...
            <!-- ... -->
            <form class="grid grid-cols-2 gap-2 shadow-xl rounded-xl py-2 h-full" action="model/algoritma.php" method="POST">
                <div class="p-2">
                    <div class="flex flex-col justify-evenly h-full">
                        <div>
                            <label class="label-style">Nama Unit 1</label>
                            <div class="mt-2">
                                <input type="text" name="nama_unit_1" class="input-style" placeholder="Meja, Buku, dll"> 
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <input type="number" name="nilai_batasan_1" class="input-style" placeholder="jika tidak ada, berikan 0!">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <input type="number" name="nilai_unit_1_untuk_batasan_1" class="input-style" placeholder="Meja, Buku, dll"> 
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <input type="number" name="nilai_unit_1_untuk_batasan_2" class="input-style" placeholder="jika tidak ada, berikan 0!">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <input type="number" name="nilai_batasan_unit_1" class="input-style" placeholder="Meja, Buku, dll"> 
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <input type="number" name="nilai_keuntungan_unit_1" class="input-style" placeholder="jika tidak ada, berikan 0!">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="p-2">
                    <div class="flex flex-col justify-evenly h-full">
                        <div>
                            ...
                            <div class="mt-2">
                                <input type="text" name="nama_unit_2" class="input-style" placeholder="Meja, Buku, dll"> 
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <input type="number" name="nilai_batasan_2" class="input-style" placeholder="jika tidak ada, berikan 0!">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <input type="number" name="nilai_unit_2_untuk_batasan_1" class="input-style" placeholder="Meja, Buku, dll"> 
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <input type="number" name="nilai_unit_2_untuk_batasan_2" class="input-style" placeholder="jika tidak ada, berikan 0!">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <input type="number" name="nilai_batasan_unit_2" class="input-style" placeholder="Meja, Buku, dll"> 
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <input type="number" name="nilai_keuntungan_unit_2" class="input-style" placeholder="jika tidak ada, berikan 0!">
                            </div>
                        </div>
                    </div>
                </div>
                
                <button class="bg-blue-300 shadow-xl rounded-sm m-2 w-40 h-8">Hitung</button>
                <button class="bg-blue-300 shadow-xl rounded-sm m-2 w-40 h-8 invisible">Hitung</button>
        ...
        ?>
        <div>
            <h2 class="text-xl font-bold tracking-tight sm:text-2xl">Hasil perhitungan</h2>
            <p class="bg-yellow-200 p-2 text-base">4 kemungkinan kombinasi terbaik : </p>
            <ol class="p-2 ml-4">
                <li><?php echo $data['kemungkinan1'] ?></li>
                <li><?php echo $data['kemungkinan2'] ?></li>
                <li><?php echo $data['kemungkinan3'] ?></li>
                <li><?php echo $data['kemungkinan4'] ?></li>
            </ol>

            <p class="bg-green-200 p-2 text-base">4 kemungkinan kombinasi terbaik : </p>
            <p class="p-2 ml-4"><?php echo $data["pilihanTerbaik"] ?></p>
